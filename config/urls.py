...
urlpatterns = [
    ...
    path("site/", include("site_trafic.urls", namespace="site")),
    path("slot_moo/", include("slot_moo.urls", namespace="slot_moo")),
    path("auto_slot/", include("auto_slot.urls", namespace="auto_slot")),
]
